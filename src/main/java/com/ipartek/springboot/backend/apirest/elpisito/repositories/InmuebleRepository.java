...
public interface InmuebleRepository extends JpaRepository<Inmueble, Long> {
    ...
    List<InmuebleImagenDTO> findAllByActivo(Integer isActivo);

    List<InmuebleImagenDTO> findByActivoAndPortada(Integer isActivo, Integer isPortada);

    List<InmuebleImagenDTO> findByInmobiliaria(Inmobiliaria inmobiliaria);

    List<InmuebleImagenDTO> findByTipoAndPoblacionAndOperacionAndActivo(Tipo tipo, Poblacion poblacion, Operacion operacion, Integer isActivo); 
